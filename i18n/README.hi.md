...
- **URL एन्कोडिंग।** curl के साथ `--data-urlencode` का उपयोग करें — कभी भी कच्चे इनपुट को URLs में इंटरपोलेट न करें।
...
इंस्टॉलेशन, आर्किटेक्चर, डिज़ाइन निर्णय और सामान्य समस्याओं के बारे में अक्सर पूछे जाने वाले प्रश्नों के लिए [FAQ.html](FAQ.html) देखें।
