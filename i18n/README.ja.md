...
よくある質問については、[FAQ.html](https://github.com/Johell1NS/browser-search/blob/main/FAQ.html) を参照してください。
...
- **URLエンコーディング。** curlでは`--data-urlencode`を使用してください — 生の入力をURLに直接挿入しないでください。
