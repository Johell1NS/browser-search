...
- **Кодирование URL.** Используйте `--data-urlencode` с curl — никогда не интерполируйте сырой ввод в URL-адреса.
...
См. [FAQ.html](FAQ.html) с часто задаваемыми вопросами об установке, архитектуре, проектных решениях и распространённых проблемах.
