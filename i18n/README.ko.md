...
자주 묻는 질문은 [FAQ.html](https://github.com/Johell1NS/browser-search/blob/main/FAQ.html)을 참조하세요.
...
- **URL 인코딩.** curl과 함께 `--data-urlencode`를 사용하세요 — 원시 입력을 URL에 직접 삽입하지 마세요.
